#!/bin/bash
set -e
/opt/docker-solr/scripts/precreate-core narrative
cp /opt/narrative/schema.xml /opt/solr/server/solr/mycores/narrative/conf/schema.xml
cp /opt/narrative/solrconfig.xml /opt/solr/server/solr/mycores/narrative/conf/solrconfig.xml
