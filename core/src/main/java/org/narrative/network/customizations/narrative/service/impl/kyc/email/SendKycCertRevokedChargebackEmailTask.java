...
public class SendKycCertRevokedChargebackEmailTask extends SendKycEmailTaskBase {
    SendKycCertRevokedChargebackEmailTask(User user, UserKycEventType eventType) {
        super(user, eventType);
    }

    @Override
    protected boolean isSupportedEventType(UserKycEventType eventType) {
        return eventType.isRevokedEventType();
    }
}
