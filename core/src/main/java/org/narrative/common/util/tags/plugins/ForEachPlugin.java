...
public final class ForEachPlugin implements TagPlugin {
    ...
    public void doTag(TagPluginContext ctxt) {
        ...
        hasVar = ctxt.isAttributeSpecified("obj");
    ...
    private void doCollection(TagPluginContext ctxt) {
        ...
        if (hasVar) {
            String iterItem = ctxt.getTemporaryVariableName();
            ctxt.generateJavaSource("Object " + iterItem + " = " + iterV + ".next();");
            ctxt.generateJavaSource("org.narrative.common.util.tags.ForEachTag.ensureForEachObjectOfProperClass(" + iterItem + ",");
            ctxt.generateAttribute("className");
            ctxt.generateJavaSource(",");
            ctxt.generateAttribute("obj");
            ctxt.generateJavaSource(");");
            ...
            ctxt.generateJavaSource("_jspx_page_context.setAttribute(");
            ctxt.generateAttribute("obj");
            ctxt.generateJavaSource(", " + iterItem + ");");
        }
