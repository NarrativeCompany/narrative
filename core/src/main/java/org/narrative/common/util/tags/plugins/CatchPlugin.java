...
public class CatchPlugin implements TagPlugin {
    ...
    public void doTag(TagPluginContext ctxt) {
        ...
        if (hasVar) {
            ...
            ctxt.generateJavaSource("    _jspx_page_context.setAttribute(\"" + strVar + "\", " + exceptionName + ", PageContext.PAGE_SCOPE);");
        }
        ...
        if (hasVar) {
            ...
            ctxt.generateJavaSource("        _jspx_page_context.removeAttribute(\"" + strVar + "\", PageContext.PAGE_SCOPE);");
            ctxt.generateJavaSource("    }");
        }
