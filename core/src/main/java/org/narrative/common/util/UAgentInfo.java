...
public class UAgentInfo {
    ...
    public transient boolean isIphone = false;
    public transient boolean isAndroidPhone = false;
    public transient boolean isTierTablet = false;
    public transient boolean isTierIphone = false;
    public transient boolean isTierRichCss = false;
    public transient boolean isTierGenericMobile = false;
    ...
    public static final String deviceKindleFireSilk = "silk"; //Kindle Fire Silk browser
    ...
    /**
     * Detects if the current device is using a Kindle Fire Silk browser
     *
     * @return detection of a Kindle Fire Silk browser
     */
    public boolean detectKindleFireSilk() {
        if (userAgent.indexOf(deviceKindleFireSilk) != -1) {
            return true;
        }
        return false;
    }
    ...
    public boolean detectWindowsMobile() {
        ...
        if (userAgent.indexOf(deviceWinMob) != -1 || userAgent.indexOf(deviceWinMob) != -1 || userAgent.indexOf(deviceIeMob) != -1 || userAgent.indexOf(enginePie) != -1 || (userAgent.indexOf(manuHtc) != -1 && userAgent.indexOf(deviceWindows) != -1) || (detectWapWml() && userAgent.indexOf(deviceWindows) != -1)) {
            return true;
        }
    ...
    public boolean detectSmartphone() {
        return (isIphone || isAndroidPhone || isTierIphone || detectS60OssBrowser() || detectSymbianOS() || detectWindowsMobile() || detectWindowsPhone7() || detectBlackBerry() || detectPalmWebOS() || detectPalmOS() || detectGarminNuvifone());
    }
    ...
    public boolean detectTierIphone() {
        if (isIphone || isAndroidPhone || (detectBlackBerryWebKit() && detectBlackBerryTouch()) || detectPalmWebOS() || detectGarminNuvifone()) {
            return true;
        }
        return false;
    }
    ...
    public boolean detectTierRichCss() {
        ...
        if (detectMobileQuick()) {
            ...
            if (!detectTierIphone()) {
                ...
                if (detectWebkit() || detectS60OssBrowser() || detectBlackBerryHigh() || detectWindowsPhone7() || detectWindowsMobile() || userAgent.indexOf(engineTelecaQ) != -1) {
                    result = true;
                } // if detectWebkit()
            } //if !detectTierIphone()
        } //if detectMobileQuick()
