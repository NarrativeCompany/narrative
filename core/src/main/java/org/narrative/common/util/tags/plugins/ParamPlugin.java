...
public class ParamPlugin implements TagPlugin {
    ...
    public void doTag(TagPluginContext ctxt) {
        ...
        ctxt.generateJavaSource("String " + urlName + " = " + "(String)_jspx_page_context.getAttribute(\"url_without_param\");");
        ...
        ctxt.generateJavaSource("    String " + encName + " = _jspx_page_context.getResponse().getCharacterEncoding();");
