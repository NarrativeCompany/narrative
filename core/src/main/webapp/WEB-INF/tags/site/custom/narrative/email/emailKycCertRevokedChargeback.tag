...
<ss:ref var="task" className="org.narrative.network.customizations.narrative.service.impl.kyc.email.SendKycCertRevokedChargebackEmailTask"/>
...
<n_email:emailWrapper
        subject="${h:wordlet('tags.site.custom.narrative.email.kyc.certificationRevokedChargeback.subject')}"
    ...
    <jsp:body>
        <e:elt name="div" cssClass="<%=EmailCssClass.CENTERED_BODY%>">
            ...
            <e:elt name="p" cssClasses="<%= Arrays.asList(EmailCssClass.TITLE, EmailCssClass.SIGNATURE_WRAPPER) %>">
                ${h:wordlet('tags.site.custom.narrative.email.kyc.certificationRevokedChargeback.subject')}
            </e:elt>

            <e:elt name="p" cssClass="<%=EmailCssClass.EMAIL_CONTENT%>">
                ${h:wordlet('tags.site.custom.narrative.email.kyc.certificationRevokedChargeback.body')}
            </e:elt>
