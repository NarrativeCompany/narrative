...
<%@ attribute name="autocomplete" type="java.lang.String" %>
...
<g:set var="passwordId" object="${gtu:createInputId(id,formId,name)}"/>
...
<gfs:controlwrapper
    ...
    ${preInputHtml}
    <gfs:textPlaceholder inputId="${passwordId}" placeholder="${placeholder}">
        ${gtu:createInput("password",name,value,enableDisabledHtmlInValue,formId,size,maxlength,null,disabled,readonly,null,tabindex,passwordId,cssClass,
